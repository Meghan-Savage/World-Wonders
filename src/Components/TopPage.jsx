...
import { FaShoppingCart, FaUser, FaSearch, FaSignOutAlt, FaSignInAlt } from "react-icons/fa";
    ...
    <nav className="bg-gray-900 py-4">
      <ul className="flex justify-between container mx-auto px-8">
        ...
        <li className="relative">
          <a href="javascript:void(0)" className="text-orange-200 hover:text-gray-400">
            Countries
          </a>
          <div className="absolute z-10 bg-white hidden">
            <a href="#" className="block px-4 py-2 text-orange-200 hover:text-gray-400">
              Country 1
            </a>
            <a href="#" className="block px-4 py-2 text-orange-200 hover:text-gray-400">
              Country 2
        ...
        <li className="navbar-right relative">
          <a href="#cart" className="text-orange-200 hover:text-gray-400 flex items-center">
        ...
        <li className="navbar-right flex items-center">
          <a href="#profile" className="text-orange-200 hover:text-gray-400 flex items-center">
