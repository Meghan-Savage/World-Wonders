...
const Terms = () => {
  return (
    <div className="container mx-auto p-6 bg-gray-50">
      <h1 className="text-2xl text-orange-400 font-bold underline mb-4 text-center">Terms Of Use</h1>
      <p className="mb-4">
        By using and accessing World Wonders.Inc, you acknowledge and agree to be bound by the following terms and conditions. Please read these terms carefully before selling any items on the Store.
      </p>
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="bg-gray-200 shadow-md p-6 transition-shadow hover:shadow-orange-200 rounded-lg ">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>b. Sellers must comply with the Store's guidelines, which include but are not limited to respecting and promoting cultural diversity, fostering inclusivity, and promoting fair trade practices.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-200 shadow-md transition-shadow hover:shadow-orange-200 rounded-lg p-6">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>b. The sale of counterfeit, replica, or unauthorized items is strictly prohibited.</li>
            <li>c. The Store reserves the right to remove any listings or suspend the account of sellers found to be selling counterfeit or unauthorized items.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-200 shadow-md transition-shadow hover:shadow-orange-200 rounded-lg p-6">
          ...
          <p className="mb-4">
            We acknowledge the diverse cultures, languages, and traditions that have been and continue to be practised by the Indigenous peoples of Alberta. We honor their wisdom, knowledge, and contributions to the heritage of this land.
          </p>
          <p className="mb-4">
            We acknowledge that the province of Alberta and the traditional territories within it were created through treaties, agreements, and occupation. We commit to learning from and supporting Indigenous peoples in their pursuit of self-determination, sovereignty, and the protection of their land, resources, and culture.
          </p>
        </div>
        ...
        <div className="bg-gray-200 shadow-md transition-shadow hover:shadow-orange-200 rounded-lg p-6">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>b. The Store respects the intellectual property rights of others and expects sellers to do the same.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-200 shadow-md transition-shadow hover:shadow-orange-200 rounded-lg p-6">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>b. Sellers must promptly fulfill orders, maintain clear communication with buyers, and provide excellent customer service.</li>
            <li>c. Sellers should promptly address any issues, concerns, or disputes raised by buyers or the Store.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-200 shadow-md rounded-lg p-6 transition-shadow hover:shadow-orange-200">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>b. The Store shall not be liable for any damages, losses, or liabilities arising from the use of the Store, including but not limited to lost profits, indirect or consequential damages.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-200 shadow-md rounded-lg p-6 transition-shadow hover:shadow-orange-200">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>b. Upon termination, the seller's access to the Store and their account will be disabled, and their listings will be removed.</li>
            <li>c. The seller remains responsible for fulfilling any pending orders or resolving any ongoing issues with buyers.</li>
          </ul>
        </div>
      </div>
